            ...
            window.openExplorerModal = function openExplorerModal(action) {
                ...
                if (action === 'create_ou') {
                    ...
                    formBody += hidden + '<input type=\"hidden\" name=\"ou_dn\" value=\"' + escapeHtml(dn) + '\">' +
                        ...
                        '<label class=\"label\">' + escapeHtml(INTRANET_I18N.js_ou_protection_field) + '</label><select class=\"input\" name=\"ou_protected_mod\"><option value=\"\">' + escapeHtml(INTRANET_I18N.js_ou_protection_no_change) + '</option><option value=\"1\"' + (ouProt ? ' selected' : '') + '>' + escapeHtml(INTRANET_I18N.js_ou_protection_on) + '</option><option value=\"0\"' + (!ouProt ? ' selected' : '') + '>' + escapeHtml(INTRANET_I18N.js_ou_protection_off) + '</option></select>';
